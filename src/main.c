...
int main(int argc, char const *argv[])
{
	...
	int play = 0, menu = 1, quit = 0, health = 3, timer_shot = 0, timer_enemy = 0, timer_shot_enemy = 0;
	...
	Spaceship spaceship = spaceship_create(get_window_width()/2 - get_spaceship_width()/2, (get_window_height()/10)*9 - get_spaceship_height());
