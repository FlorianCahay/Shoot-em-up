...
int main(int argc, char const *argv[])
{
	...
	while (!quit) {
		...
		/* Test hitbox */
		shot_hit_enemy(data_game.hitbox.enemy, data_game.hitbox.shot_ally, &(data_game.lists.enemies), &(data_game.lists.shots), &score, &(data_game.lists.animations), animation_player);
		spaceship_hit_enemy(data_game.hitbox.spaceship, data_game.hitbox.enemy, spaceship,&(data_game.lists.enemies), &health);
